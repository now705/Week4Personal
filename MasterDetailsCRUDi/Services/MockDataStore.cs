...
namespace MasterDetailsCRUDi.Services
{
    public sealed class MockDataStore : IDataStore
    {
        ...
        private MockDataStore()
        {
            ...
            {
                new Item { Id = Guid.NewGuid().ToString(), Name = "Mock item", Description="This is an item description." },
                new Item { Id = Guid.NewGuid().ToString(), Name = "Mock item", Description="This is an item description." },
                new Item { Id = Guid.NewGuid().ToString(), Name = "Mock item", Description="This is an item description." },
                new Item { Id = Guid.NewGuid().ToString(), Name = "Mock item", Description="This is an item description." },
                new Item { Id = Guid.NewGuid().ToString(), Name = "Mock item", Description="This is an item description." },
            ...
            {
                new Character { Id = Guid.NewGuid().ToString(), Name = "Mock Character", Description="This is an Character description.", Age = 1 },
                new Character { Id = Guid.NewGuid().ToString(), Name = "Mock Character", Description="This is an Character description." , Age = 1},
                new Character { Id = Guid.NewGuid().ToString(), Name = "Mock Character", Description="This is an Character description." , Age = 2},
                new Character { Id = Guid.NewGuid().ToString(), Name = "Mock Character", Description="This is an Character description." , Age = 2},
                new Character { Id = Guid.NewGuid().ToString(), Name = "Mock Character", Description="This is an Character description." , Age = 3},
                new Character { Id = Guid.NewGuid().ToString(), Name = "Mock Character", Description="This is an Character description." , Age = 3},
            };
            ...
            {
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Mock Monster", Description="This is an Monster description." },
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Mock Monster", Description="This is an Monster description." },
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Mock Monster", Description="This is an Monster description." },
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Mock Monster", Description="This is an Monster description." },
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Mock Monster", Description="This is an Monster description." },
